...
# read counts df
funk_list_counts <- read.csv(file = "output/dataframes/funk_list_counts.csv", check.names = F)
...
pdf(file = 'output/figures/Figure01_A.pdf', height = 5.5, width = 3.25)
count_plot_rects
dev.off()
...
pdf(file = 'output/figures/Figure01_B.pdf', height = 5.5, width = 3.25)
...
pdf(file = 'output/figures/Figure02_test.pdf', height = 3, width = 3.25)
...
pdf(file = 'output/figures/Figure03_B.pdf', height = 4, width = 2.2)
family_bars
dev.off()
