  ...
  google_auth_json <- "" # path to your google api json here
  ...
  funk <- read.funky.table("data/countries/funk_countries.tsv")
  mexia <- read.funky.table("data/countries/mexia_countries_edited.tsv")
  chase <- read.funky.table("data/countries/chase_countries_edited.tsv")
  rudd <- read.funky.table("data/countries/rudd_countries_edited.tsv")
  
  # 
  # robinson <- read.funky.table("data/countries/robinson_countries2.tsv")
  # sfblake <- read.funky.table("data/countries/sfblake_countries_edited.tsv")
  ...
  pdf(file = "map_with_bars_botany.pdf", height = 5, width = 9)
  ...
  # apply function to load data (ignore warning about end of line)
  funk <- read.funky.table("data/countries/funk_countries.tsv")
  calderon <- read.funky.table("data/countries/calderon_countries2.tsv")
  chase <- read.funky.table("data/countries/chase_countries_edited.tsv")
  rudd <- read.funky.table("data/countries/rudd_countries_edited.tsv")
  ...
  # apply function to load data (ignore warning about end of line)
  mclaughlin <- read.funky.table("data/countries/mclaughlin_countries_edited.tsv")
  rice <- read.funky.table("data/countries/rice_countries_edited.tsv")
  rathbun <- read.funky.table("data/countries/rathbun_countries_edited.tsv")
  pettibone <- read.funky.table("data/countries/pettibone_countries_edited.tsv")
  ...
  pdf(file = "map_with_bars_iz.pdf", height = 5, width = 9)
  map_with_bars + coord_fixed()
  dev.off()
